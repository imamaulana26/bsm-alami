...
<head>
	...
	<link rel="icon" type="image/png" href="<?= base_url('assets/template') ?> /dist/img/logo-bsm.png" />

	<title>BSM - Alami</title>
	...
	<!-- Bootstrap Select -->
	<link rel="stylesheet" href="<?= base_url('assets/template') ?>/plugins/bootstrap-select/dist/css/bootstrap-select.min.css">
