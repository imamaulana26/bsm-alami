			...
			<form id="fm_share">
				<div class="modal-body">
					...
					<div class="form-group row">
						...
						<div class="col-sm-6">
							<select class="form-control selectpicker" name="penugasan" id="penugasan" data-live-search="true" required></select>
						</div>
					</div>
				</div>
...
<?php $this->load->view('staff/detail/modal_finance'); ?>
...
<script>
	...
	function detail_modal(key) {
		...
		$.ajax({
			url: '<?= site_url('staff/finance/detail/') ?>' + key,
			type: 'get',
			dataType: 'json',
	...
	function share(id) {
		...
		$.ajax({
			url: '<?= site_url('staff/finance/detail/') ?>' + id,
			type: 'get',
			dataType: 'json',
			success: function(res) {
	...
	function btn_share() {
		$.ajax({
			url: '<?= site_url('staff/finance/penugasan') ?>',
			type: 'post',
			dataType: 'json',
